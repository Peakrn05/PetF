                ...
                {filteredServices.map((s) => (
                  ...
                  >
                    <div className="flex justify-between items-start gap-3">
                      ...
                      <span className="font-bold text-primary whitespace-nowrap text-lg">{s.basePrice.toLocaleString()} <span className="text-xs font-normal text-gray-400">THB</span></span>
                    </div>
                  </button>
                ))}
              </div>
              ...
              {!user && (
                <div className="mb-4 p-4 bg-blue-50 border border-blue-100 rounded-xl">
                  <p className="text-sm text-blue-700">
                    Log in to save pets across sessions. You can still continue as a guest.
                  </p>
                </div>
              )}
          ...
          {step === 3 && (
            <div>
              ...
              <TextField value={notes} onChange={setNotes} className="mb-5">
                ...
                <TextArea placeholder="Any special requests, allergies, or instructions?" />
              </TextField>
